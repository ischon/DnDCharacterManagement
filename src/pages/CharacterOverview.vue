...
`
  ...
  const openShortRestModal = () => {
    editingPopup.atClickEdit(character, [
      ...
      [
        'Usable hit Dice',
        'statCurrentAmountHitDice',
        character.statCurrentAmountHitDice,
        ModelTypes.number
      ],
      ['Max hit points', '', character.statHitPointMaximumValue, ModelTypes.disabled],
      [
        `Current hit points`,
        'statHitPointsCurrent',
        character.statHitPointsCurrent,
        ModelTypes.number
      ]
    ])
  }
  const openLevelUpModal = () => {
    let items = [
      ...
      [
        ...
        'abilityConstitutionModifier',
        character.abilityConstitutionModifier,
        ModelTypes.disabled
      ],
      [
        'Additional hit points',
        'statHitPointsMisc',
        character.statHitPointsMisc,
        ModelTypes.number
      ],
      [
        `Current hit points`,
      ...
      [
        'Experience points',
        'detailExperiencePoints',
        character.detailExperiencePoints,
        ModelTypes.number
      ]
    ]
    let spellslots = []
...
<template>
  <div v-if="!loading.character">
    <div id="quick-actions" class="page container col">
      ...
      <div class="body container row flex-1">
        <div
          class="block container value-display justify-center col clickable"
    ...
    <div id="page-1" class="page container col">
      ...
      <div class="header container row flex-1">
        ...
        <div class="container col flex-1">
          <!-- Left Column -->
          <div
            class="container value-display col block flex-1 no-border-top no-border-left clickable"
            @click="
              editingPopup.atClickEdit(character, [
                ['Character Name', 'detailName', character.detailName, ModelTypes.text]
              ])
            "
          >
        ...
        <div class="container col flex-2">
          ...
          <div class="container row">
            <div
              class="container block value-display col flex-1 no-border-top clickable"
              @click="
                editingPopup.atClickEdit(character, [
            ...
            >
              <p class="flex-1 value medium no-transform">
                {{ character.detailClass }} lvl {{ character.detailLevel }}
              </p>
          ...
          <div class="container row">
            <div
              class="container block value-display col flex-1 clickable"
              @click="
                editingPopup.atClickEdit(character, [
            ...
            <div
              class="container block value-display col flex-1 no-border-right clickable"
              @click="
                editingPopup.atClickEdit(character, [
                  [
                    'Experience points',
            ...
            >
              <p class="flex-1 value medium no-transform">
                {{
                  character.detailExperiencePoints !== 0 ? character.detailExperiencePoints : '-'
                }}
              </p>
          ...
          <div class="container col flex-1">
            ...
            <div class="container flex-1 block row labeled-row no-border-left">
              <div class="value flex-1">
                <p>{{ formatScore(character.proficiencyBonus) }}</p>
              </div>
              <div class="label flex-2"><p>Proficiency Bonus</p></div>
            </div>
            <div
              class="container flex-1 block row labeled-row no-border-left clickable"
              @click="
                editingPopup.atClickEdit(character, [
                  [
                    'Inspiration',
                    'abilityInspiration',
                    character.abilityInspiration,
                    ModelTypes.checkbox
                  ]
                ])
              "
            ...
            >
              <!--ABILITY-->
              <div
                class="container ability col flex-1 clickable"
                @click="
                  () => {
                    let items = [
              ...
              >
                <div class="ability-modifier flex-1">
                  <p class="content no-label">{{ formatScore(ability.modifier) }}</p>
                </div>
              ...
              <div class="container skill col flex-2">
                ...
                <div v-for="(skill, skill_name) in ability.skills" :key="skill_name" class="skill-row flex-1">
                  <div
                    ...
                    :class="{
                      selected:
                        character.proficiencies[ability_name.toLowerCase()].includes(skill_name)
                    }"
            ...
            <div class="container flex-1 block row labeled-row no-border-left">
              <div class="value flex-1">
                <p>{{ character.abilityPassivePerception }}</p>
              </div>
                ...
                <div class="container row flex-1">
                    ...
                    @click="
                      editingPopup.atClickEdit(character, [
                        [
                          'Armor class basis',
                          'statArmorClassBase',
                          character.statArmorClassBase,
                          ModelTypes.number
                        ],
                        [
                          `Type of Armor`,
                          'statArmorClassArmorType',
                          character.statArmorClassArmorType,
                          ModelTypes.armor
                        ],
                        [
                          'Added protection from a shield',
                          'statArmorClassShield',
                          character.statArmorClassShield,
                          ModelTypes.number
                        ],
                        [
                          'Additional modifier',
                          'statArmorClassMisc',
                          character.statArmorClassMisc,
                          ModelTypes.number
                        ]
                      ])
                    "
                  ...
                  <div
                    ...
                    @click="
                      editingPopup.atClickEdit(character, [
                        [
                          'Dexterity modifier',
                          'abilityDexterityModifier',
                          character.abilityDexterityModifier,
                          ModelTypes.disabled
                        ],
                        [
                          `Additional modifier`,
                          'abilityInitiativeMisc',
                          character.abilityInitiativeMisc,
                          ModelTypes.number
                        ]
                      ])
                    "
                  >
                    <p class="flex-1 value">
                      {{ formatScore(character.abilityInitiativeModifier) }}
                    </p>
                    <p>Initiative</p>
                  </div>
                  <div
                  ...
                  <div
                    ...
                    @click="
                      editingPopup.atClickEdit(character, [
                        [
                          'Successful rolls',
                          'statDeathSavesSuccesses',
                          character.statDeathSavesSuccesses,
                          ModelTypes.number
                        ],
                        [
                          'Failed rolls',
                          'statDeathSavesFailures',
                          character.statDeathSavesFailures,
                          ModelTypes.number
                        ]
                      ])
                    "
                ...
                <div
                  ...
                  @click="
                    editingPopup.atClickEdit(character, [
                      [
                        'Traits',
                        'detailPersonalityTraits',
                        character.detailPersonalityTraits,
                        ModelTypes.textarea
                      ]
                    ])
                  "
        ...
        <div class="container row flex-1">
          ...
          <div class="container col flex-2">
            <div class="container flex-1 block col value-display no-border-right no-border-bottom">
              <div class="container row flex-1">
                <div
                  class="container col flex-1 clickable"
                  @click="
                    editingPopup.atClickEdit(character, [
        ...
        <div class="container col flex-2">
          ...
          <div class="container row">
            <div
              ...
              @click="
                editingPopup.atClickEdit(character, [
                  ['Character Age in years', 'detailAge', character.detailAge, ModelTypes.number]
                ])
              "
            >
            ...
            <div
              ...
              @click="
                editingPopup.atClickEdit(character, [
                  [
                    'Character Height in foot',
                    'detailHeight',
                    character.detailHeight,
                    ModelTypes.number
                  ]
                ])
              "
            >
              <p class="flex-1 value medium no-transform">
                {{ formatLength(character.detailHeight) }}
              </p>
              <p>Height</p>
            </div>
            <div
              class="container block value-display col flex-1 no-border-top no-border-right clickable"
              @click="
                editingPopup.atClickEdit(character, [
                  [
                    'Character Weight in pounds',
                    'detailWeight',
                    character.detailWeight,
                    ModelTypes.number
                  ]
                ])
              "
            >
              <p class="flex-1 value medium no-transform">
                {{ formatWeight(character.detailWeight) }}
              </p>
              <p>Weight</p>
            </div>
          </div>
          <div class="container row">
            <div
              ...
              @click="
                editingPopup.atClickEdit(character, [
                  ['Character Eyes', 'detailEyeColor', character.detailEyeColor, ModelTypes.text]
                ])
              "
            >
            ...
            <div
              ...
              @click="
                editingPopup.atClickEdit(character, [
                  ['Character Skin', 'detailSkinColor', character.detailSkinColor, ModelTypes.text]
                ])
              "
            >
            ...
            <div
              ...
              @click="
                editingPopup.atClickEdit(character, [
                  ['Character Hair', 'detailHairColor', character.detailHairColor, ModelTypes.text]
                ])
              "
            >
      ...
      <div class="body container row">
        <div class="container col flex-1">
          <div class="container block value-display col flex-1 no-border-left">
            <div class="flex-1">
              <img
                v-if="!loading.image && characterImage"
                :src="characterImage"
                class="character-appearance clickable"
          ...
          <div
            class="container block value-display col flex-2 no-border-left no-border-bottom clickable"
            @click="
              editingPopup.atClickEdit(character, [
                [
                  'Character Backstory',
                  'detailBackstory',
                  character.detailBackstory,
                  ModelTypes.textarea
                ]
              ])
            "
        ...
        <div class="container col flex-2">
          <div
            class="container block value-display align-start col flex-1 no-border-right clickable"
            @click="
              editingPopup.atClickEdit(character, [
                ['Important Notes', 'notes', character.notes, ModelTypes.textarea]
              ])
            "
          >
            <div class="flex-1">
          ...
          <div
            class="container block value-display align-start col flex-1 no-border-right no-border-bottom clickable"
            @click="
              editingPopup.atClickEdit(character, [
                ['Treasure', 'detailTreasure', character.detailTreasure, ModelTypes.textarea]
              ])
            "
          >
            <div class="flex-1">
          ...
          <div class="container row">
            ...
            <div class="container row flex-2">
              ...
              <div class="container block value-display col flex-1 no-border-top">
                <p class="flex-1 value medium no-transform">
                  {{ character.spellcastingSpellSaveDc }}
                </p>
                <p>Spell Save DC</p>
              </div>
              <div class="container block value-display col flex-1 no-border-top no-border-right">
                <p class="flex-1 value medium no-transform">
                  {{ formatScore(character.spellcastingAttackBonus) }}
                </p>
        ...
        >
          <div
            ...
            :class="{
              ...
              'no-border-right': key === 2
            }"
          >
            <div class="container row labeled-row" style="margin-bottom: 0.5rem">
              <div class="value flex-1">
                <p>lvl {{ j }}</p>
              </div>
              ...
              <div v-if="j !== 0" class="flex-3 container row">
                <div
                  ...
                  @click="
                    editingPopup.atClickEdit(character, [
                      [
                        'Spell Slots',
                        `_character.spellcasting.spells.${j}.spellSlots`,
                        character.spellcastingSpellSlots_get(j),
                        ModelTypes.number
                      ]
                    ])
                  "
                ...
                <div
                  ...
                  @click="
                    editingPopup.atClickEdit(character, [
                      [
                        'Spell Slots Expanded',
                        `_character.spellcasting.spells.${j}.spellSlotsExpanded`,
                        character.spellcastingSpellSlotsExpanded_get(j),
                        ModelTypes.number
                      ]
                    ])
                  "
  ...
  <div
    v-if="editingPopup.editing.open"
    class="popup container col"
